...
function Stage({
  ...
  React.useEffect(() => {
    ...
    // detail.sync === true gets the commit applied via flushSync,
    ...
    // flushSync never advertises and every seek takes the async
  ...
  return (
    <React.Fragment>
      <Stage width={width} height={height} duration={derived.total} background={bg}
              autoplay={autoplay} loop={loop} showPlaybackBar={props.showPlaybackBar !== false} playback={pb}>
